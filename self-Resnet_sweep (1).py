...
def train(config=None):
    ...
    with wandb.init(config=config):
        ...
        for epoch in range(config.epochs):
            ...
            overall_dice = cal_dice(large_inter, large_union, small_inter, small_union)
            ...
            overall_dice_val = cal_dice(val_large_inter, val_large_union, val_small_inter, val_small_union)
...
if __name__ == "__main__":
    ...
    if config['train_mode'] == "reconstruction":
        ...
        wandb.agent(sweep_id, train_self, count=15)
